...
<div class="container">
<h1 class="hello">Sign Up</h1>
    <p class="hello">Only for the Restaurant's Manager....</p>
    <hr>

            <label for="username">Restaurant's Name: </label>
           
              <input class="form-control" id="username" type="text" name="username" placeholder="Your Restaurant's name" required="">
