...
$query = "INSERT into Restaurants(username,email,contact,address,password) VALUES('" . $username . "','" . $email . "','" . $contact . "','" . $address ."','" . $password ."')";
...
<div class="contain">
	<div class="jumbotron" style="text-align: center;">
		<h2 class="k"> <?php echo "Welcome $username!" ?> </h2>
		<h1 class ="kk">Your account has been created.</h1>
		<p class="kk">Login Now from <a href="managerlogin.php">HERE</a></p>
	</div>
</div>
